...
if (!isset($_GET['id'])) {
    header("Location: dokter_users.php");
    exit;
}
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid py-4">
                <h1 class="mb-4 text-primary"><i class="fas fa-user-edit"></i> Edit Dokter</h1>
                <a href="dokter_users.php" class="btn btn-secondary mb-3">&laquo; Kembali</a>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <button type="submit" name="update_dokter" class="btn btn-success">Simpan Perubahan</button>
                        </form>
                    </div>
                </div>
