...
if (isset($_POST['update_admin'])) {
    ...
    if (empty($errors)) {
        ...
        if ($koneksi->query($sql)) {
            $success = "Data Apoteker berhasil diperbarui!";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid py-4">
                <h1 class="mb-4 text-primary"><i class="fas fa-user-edit"></i> Edit Apoteker</h1>
                <a href="apoteker_users.php" class="btn btn-secondary mb-3">&laquo; Kembali</a>

                <!-- Card Form Edit Admin -->
                <div class="card mb-4">
                    <div class="card-header">Form Edit Apoteker</div>
                    <div class="card-body">
